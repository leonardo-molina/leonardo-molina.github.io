...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    specifications: {
      ...
      teamSize: '12 Engineers',
      languages: [],
      hardware: ['CubeMars-MAB AK10-9 Driving Actuators', 'CubeMars-MAB AK70-9 Crab-Steering Actuators', 'Thriftybot Cycloidal Gearboxes (23:1)', 'Carbon-Fiber Tube Suspension Legs', '6061-T6 Aluminum Chassis', 'Thrust Needle Roller Bearings'],
    ...
    images: {
      ...
      approach: {
        src: '/WheelModuleCrossSection.png',
        caption: 'Figure 2: Section view of a wheel corner module, showing the crab-steering actuator and cycloidal gearbox packaged inside the carbon-fiber leg.'
      },
      hardware: {
        src: '/SuspensionCADAssembly.png',
        caption: 'Figure 3: CAD assembly of the rocker-style suspension, rear differential pivot, and four wheel corner mounts.'
      }
    },
    sections: {
      ...
      approach: 'I ran the sub-team through the same research-to-fabrication pipeline for each major structural component, chassis, suspension, and wheel modules: material research and simulation first, then design selection, CAD modeling, FEA verification, fabrication, and physical testing, so every structural decision was checked analytically before it was cut in metal. That process led us to relocate the central differential pivot to the rear of the chassis, improving the rover\'s ability to pivot in place and hold traction across uneven terrain, and to reinforce the chassis-to-axle connections that had been the main source of deformation and wheel deflection on the previous rover generation. Moving from a fixed-axle layout to independent crab steering also meant each wheel corner now had to carry its own steering actuator and gearbox, so I had the sub-team package the actuator and cycloidal gearbox directly inside a slim carbon-fiber leg rather than in a separate housing.',
      hardware: 'The chassis and suspension mix materials by load path: 6061-T6 aluminum for the high-load chassis rails and axle mounts, and carbon-fiber tube for the four suspension legs, trading a small amount of stiffness for the weight that solid aluminum legs would have added on top of the rover\'s arm, science, and compute payload. Each leg terminates in a wheel corner module built around a CubeMars-MAB AK10-9 driving actuator paired with a Thriftybot 23:1 cycloidal gearbox for propulsion, plus a second AK70-9 actuator dedicated to steering that wheel independently of the other three. The central differential pivot, relocated to the rear of the chassis for this generation, rides on thrust needle roller bearings sized to carry the axial load transferred through the rocker-style suspension as the rover articulates over rocks and uneven ground.',
